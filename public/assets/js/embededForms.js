...
//   let prototype = $collectionHolderLesson.data("prototype");
//   let index = $collectionHolderLesson.data("index");
//   let newForm = prototype;

//   newForm = newForm.replace(/_name_/g, index);

//   $collectionHolderLesson.data("index", index++);

//   let $panelLesson = $(
//     '<div class="panel_lesson panel_lessonWrap key_bg2"><div class="panel_lessonHead"></div></div>'
//   );

//   let $panelLessonBody = $('<div class="panel_lessonBody"></div>').append(
//     newForm
//   );

//   $panelLesson.append($panelLessonBody);

//   addOptionSection($panelLesson);

//   $addNewLesson.before($panelLesson);
// }

// function addNewButtonLesson() {
//   $imageAdd = $(
//     'img src="" alt="icone ajouter" title="icon by : https://icons8.com/icon/37839/ajouter">'
//   );
//   $imageAdd.attr("src", "../../assets/storage/icons/add.png");
//   $addNewLesson = $('<button class="btn btnAddLesson key_bg1"></button>');
//   $addNewLesson.append($imageAdd);

//   let $panelFooter = $('<div class="panel_footer key_bg2">').append(
//     "$addNewLesson"
//   );
//   // $panelFooter.append($addNewLesson);
//   let $panelSection = $(
//     '<div class="panel_section panel_sectionWrap key_bg2"><div class="panel_heading"></div></div>'
//   );
